(function () {
  ...
  function homePage() {
    ...
    <section class="hero"><div class="container">
      <div class="hero-copy">
        <div class="eyebrow">Handcrafted in Bangladesh</div>
        <h1>Table runners, cushion covers &amp; home textiles for every room</h1>
        <p>Nakshi kantha, jamdani motifs and natural jute — sourced directly from artisans in Jashore, Tangail and Rangpur.</p>
        <div class="hero-actions"><a class="btn btn-primary" href="#/shop">Shop All Products</a><a class="btn btn-outline" href="${catHref('Table Runners')}">Table Runners</a></div>
      </div>
      <img src="${px(14132973, 1200)}" alt="Elegant dining table setting">
    </div></section>
